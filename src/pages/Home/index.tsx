...
<div className="card-deck-wrapper container" style={{marginTop: "5%"}}>
        <div className="card-deck">
            ...
            <img src={imgOfertas} alt="" style={{width:"100%", height:"280px", borderRadius: "15px"}} />
            ...
            <Link className="normalButtons" to="/productosyservicios" style={{textDecoration:"none"}}>
                <img src={imgProductosServicios} alt="" style={{width:"100%", height:"280px", borderRadius: "15px"}} />
            ...
            <Link className="normalButtons" to="/empresas" style={{textDecoration:"none"}}>
                <img src={imgEmpresas} alt="" style={{width:"100%", height:"280px", borderRadius: "15px"}} />
