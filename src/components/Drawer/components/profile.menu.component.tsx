import { Mail, Notifications, AccountCircle, More, MoreVert } from "@mui/icons-material";
import { Badge, Box, IconButton, Menu, MenuItem, PopoverVirtualElement } from "@mui/material";
...
export const ProfileMenuComponent: FC<ProfileMenuComponent> = ({
    anchorEl, menuId, isMenuOpen, handleMenuClose, handleMobileMenuOpen, handleProfileMenuOpen, mobileMenuId }) => {
